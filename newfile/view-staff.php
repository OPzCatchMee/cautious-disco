   ...
   <div class="rgba-background clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="ppu32072"><!-- column -->
       ...
       <div class="MenuItemContainer clearfix grpelem" id="u32134"><!-- vertical box -->
        ...
        <div class="SubMenu MenuLevel1 clearfix" id="u32135"><!-- vertical box -->
         <ul class="SubMenuView clearfix colelem" id="u32136"><!-- vertical box -->
          ...
          <li class="MenuItemContainer clearfix colelem" id="u32137"><!-- horizontal box --><a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem" id="u32140" href="view-staff.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u32142" alt="&nbsp;View Staff" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a></li>
     ...
     <div class="colelem shared_content" id="u37038" data-content-guid="u37038_content"><!-- custom html -->
      <?php
//Staff's view of Staff.  They can only view staff members but not edit or delete them
...
// Define the query:
$q = "SELECT First_Name, Last_Name, Email, Job_Title, Phone, STAFF.Staff_ID
...
echo '<table>
<thead>
	<th><a href="view-staff.php?sort=fn">First Name</a></th>
	<th><a href="view-staff.php?sort=ln">Last Name</a></th>
	<th><a href="view-staff.php?sort=title">Job Title</a></th>
	<th><a href="view-staff.php?sort=phone">Phone</a></th>
	<th><a href="view-staff.php?sort=id">Staff ID</a></th>
</thead>
';
...
if ($pages > 1) {
	...
	if ($current_page != 1) {
		echo '<a href="view-staff.php?s=' . ($start - $display) . '&p=' . $pages . '&sort=' . $sort . '">Previous</a> ';
	}
	// Make all the numbered pages:
	for ($i = 1; $i <= $pages; $i++) {
		if ($i != $current_page) {
			echo '<a href="view-staff.php?s=' . (($display * ($i - 1))) . '&p=' . $pages . '&sort=' . $sort . '">' . $i . '</a> ';
		} else {
			echo $i . ' ';
		}
	} // End of FOR loop.
	...
	if ($current_page != $pages) {
		echo '<a href="view-staff.php?s=' . ($start + $display) . '&p=' . $pages . '&sort=' . $sort . '">Next</a>';
	}
       ...
       <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u32134"><!-- vertical box -->
        ...
        <div class="SubMenu MenuLevel1 clearfix temp_no_id" data-orig-id="u32135"><!-- vertical box -->
         <ul class="SubMenuView clearfix colelem temp_no_id" data-orig-id="u32136"><!-- vertical box -->
          ...
          <li class="MenuItemContainer clearfix colelem temp_no_id" data-orig-id="u32137"><!-- horizontal box --><a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem temp_no_id" href="view-staff.php" data-orig-id="u32140"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="&nbsp;View Staff" src="images/blank.gif?crc=4208392903" data-orig-id="u32142"/><!-- state-based BG images --></a></li>
