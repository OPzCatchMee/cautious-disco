 ...
 <body>
  ...
  <div class="breakpoint active" id="bp_infinity" data-min-width="923"><!-- responsive breakpoint node -->
   <div class="rgba-background clearfix borderbox" id="page"><!-- group -->
    <a class="nonblock nontext MuseLinkActive clip_frame grpelem" id="u2368" href="admin.php"><!-- image --><img class="block temp_no_img_src" id="u2368_img" data-orig-src="images/website_logo.png?crc=3983792562" alt="" data-image-width="123" data-image-height="162" src="images/blank.gif?crc=4208392903"/></a>
    <nav class="MenuBar clearfix" id="menuu3329"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u3337"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive shadow rgba-background rounded-corners clearfix colelem" id="u3338" href="admin.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u3339" alt="Home" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u3543"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u3546" href="admin-about-us.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u3548" alt="About Us" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u3572"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u3573" href="admin-competitions.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u3574" alt="Competitions" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u3600"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u3603" href="admin-faqs.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u3606" alt="FAQs" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
    </nav>
   ...
   <div class="rgba-background clearfix borderbox temp_no_id" data-orig-id="page"><!-- group -->
    ...
    <nav class="MenuBar clearfix temp_no_id" data-orig-id="menuu3329"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u3337"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="admin.php" data-orig-id="u3338"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="Home" src="images/blank.gif?crc=4208392903" data-orig-id="u3339"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u3543"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="admin-about-us.php" data-orig-id="u3546"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="About Us" src="images/blank.gif?crc=4208392903" data-orig-id="u3548"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u3572"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="admin-competitions.php" data-orig-id="u3573"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="Competitions" src="images/blank.gif?crc=4208392903" data-orig-id="u3574"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u3600"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="admin-faqs.php" data-orig-id="u3603"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="FAQs" src="images/blank.gif?crc=4208392903" data-orig-id="u3606"/><!-- state-based BG images --></a>
     </div>
    </nav>
