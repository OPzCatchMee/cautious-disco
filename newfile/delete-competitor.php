  ...
  <div class="breakpoint active" id="bp_infinity" data-min-width="923"><!-- responsive breakpoint node -->
   <div class="rgba-background clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="clearfix grpelem" id="ppu2370"><!-- column -->
     ...
     <img class="colelem temp_no_img_src" id="u36994-4" alt="Delete Competitor" data-orig-src="images/u36994-4.png?crc=4073432954" data-image-width="630" src="images/blank.gif?crc=4208392903"/><!-- rasterized frame -->
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (mysqli_num_rows($r) == 1) { // Valid competitor ID, show the form.
		...
		// Create the form:
		echo '<form action="delete-competitor.php" method="post">
