   ...
   <div class="rgba-background clearfix borderbox" id="page"><!-- group -->
    ...
    <nav class="MenuBar clearfix" id="menuu3329"><!-- horizontal box -->
     ...
     <div class="MenuItemContainer clearfix grpelem" id="u3572"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix colelem" id="u3573" href="admin-competitions.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u3574" alt="Competitions" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
...
echo '<table>
<thead>
	<th><a href="admin-competitions.php?sort=ln">Location Name</a></th>
	<th><a href="admin-competitions.php?sort=street">Street</a></th>
	<th><a href="admin-competitions.php?sort=city">City</a></th>
	<th><a href="admin-competitions.php?sort=state">State</a></th>
	<th><a href="admin-competitions.php?sort=zip">ZIP</a></th>
	<th><a href="admin-competitions.php?sort=date">Date</a></th>
	<th><a href="admin-competitions.php?sort=time">Time</a></th>
	<th><a href="admin-competitions.php?sort=name">Competition Name</a></th>
</thead>
';
     ...
     <div class="clearfix colelem temp_no_id" data-orig-id="pu2370"><!-- group -->
      ...
      <nav class="MenuBar clearfix grpelem" id="menuu11233"><!-- vertical box -->
       ...
       <div class="MenuItemContainer borderbox clearfix colelem" id="u11241"><!-- horizontal box -->
        <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive borderbox clearfix grpelem" id="u11244" href="admin-competitions.php"><!-- horizontal box --><div class="MenuItemLabel grpelem" id="u11245"><!-- state-based BG images --><img alt="Competitions" src="images/blank.gif?crc=4208392903" class="shared_content" data-content-guid="u11245_0_content"/><div class="fluid_height_spacer shared_content" data-content-guid="u11245_1_content"></div></div></a>
       </div>
    ...
    <div class="clearfix colelem" id="pu2368"><!-- group -->
     ...
     <nav class="MenuBar clearfix grpelem temp_no_id" data-orig-id="menuu11233"><!-- vertical box -->
      ...
      <div class="MenuItemContainer borderbox clearfix colelem temp_no_id" data-orig-id="u11241"><!-- horizontal box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive borderbox clearfix grpelem temp_no_id" href="admin-competitions.php" data-orig-id="u11244"><!-- horizontal box --><div class="MenuItemLabel grpelem temp_no_id" data-orig-id="u11245"><!-- state-based BG images --><span class="placeholder" data-placeholder-for="u11245_0_content"><!-- placeholder node --></span><span class="fluid_height_spacer placeholder" data-placeholder-for="u11245_1_content"><!-- placeholder node --></span></div></a>
      </div>
