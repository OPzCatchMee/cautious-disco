   ...
   <div class="rgba-background clearfix borderbox" id="page"><!-- group -->
    ...
    <nav class="MenuBar clearfix" id="menuu27592"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem" id="u27593"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u27594" href="competitor.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u27597" alt="Home" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u27600"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u27603" href="competitor-about-us.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u27605" alt="About Us" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u27607"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u27608" href="competitor-competitions.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u27610" alt="Competitions" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem" id="u27614"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem" id="u27615" href="competitor-faqs.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u27617" alt="FAQs" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a>
     </div>
    </nav>
       ...
       <div class="MenuItemContainer clearfix grpelem" id="u27524"><!-- vertical box -->
        ...
        <div class="SubMenu MenuLevel1 clearfix" id="u27525"><!-- vertical box -->
         <ul class="SubMenuView clearfix colelem" id="u27526"><!-- vertical box -->
          <li class="MenuItemContainer clearfix colelem" id="u27576"><!-- horizontal box --><a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem" id="u27579" href="view-and-edit-competitor.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u27580" alt="&nbsp;Manage Account" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a></li>
...
if ((isset($_SESSION['Competitor_ID'])) || $_SESSION['Is_Admin'])
...
$q = "SELECT ID_Login,First_Name, Last_Name, Street, City, State, ZIP, Phone, Email
	FROM (LOGIN INNER JOIN COMPETITOR_ID ON LOGIN.ID_Login=COMPETITOR_ID.User INNER JOIN COMPETITOR ON COMPETITOR_ID.Competitor=COMPETITOR.ID)
	WHERE COMPETITOR_ID.Competitor=$competitor_id";
$r = @mysqli_query ($dbc, $q);
if (mysqli_num_rows($r) == 1) { // Valid user ID, show the form.
	...
	echo '<form action="view-and-edit-competitor.php?id=' . $row['ID_Login'] .'" method="post">
	<div>
   ...
   <div class="rgba-background clearfix borderbox temp_no_id" data-orig-id="page"><!-- group -->
    ...
    <nav class="MenuBar clearfix temp_no_id" data-orig-id="menuu27592"><!-- horizontal box -->
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u27593"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="competitor.php" data-orig-id="u27594"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="Home" src="images/blank.gif?crc=4208392903" data-orig-id="u27597"/><!-- state-based BG images --></a>
     </div>
     ...
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u27607"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="competitor-competitions.php" data-orig-id="u27608"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="Competitions" src="images/blank.gif?crc=4208392903" data-orig-id="u27610"/><!-- state-based BG images --></a>
     </div>
     <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u27614"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu shadow rgba-background rounded-corners clearfix colelem temp_no_id" href="competitor-faqs.php" data-orig-id="u27615"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="FAQs" src="images/blank.gif?crc=4208392903" data-orig-id="u27617"/><!-- state-based BG images --></a>
     </div>
    </nav>
