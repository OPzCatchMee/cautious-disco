       ...
       <div class="MenuItemContainer clearfix grpelem" id="u2398"><!-- vertical box -->
        ...
        <div class="SubMenu MenuLevel1 clearfix" id="u2399"><!-- vertical box -->
         <ul class="SubMenuView clearfix colelem" id="u2400"><!-- vertical box -->
          ...
          <li class="MenuItemContainer clearfix colelem" id="u14717"><!-- horizontal box --><a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem" id="u14718" href="view-competitors.php"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem" id="u14721" alt="&nbsp;View Competitors" src="images/blank.gif?crc=4208392903"/><!-- state-based BG images --></a></li>
...
echo '<table>
<thead>
  <th><a href="view-competitors.php?sort=fn">First Name</a></th>
  <th><a href="view-competitors.php?sort=ln">Last Name</a></th>
  <th><a href="view-competitors.php?sort=birth">Date of Birth</a></th>
  <th><a href="view-competitors.php?sort=street">Street</a></th>
  <th><a href="view-competitors.php?sort=city">City</a></th>
  <th><a href="view-competitors.php?sort=state">State</a></th>
  <th><a href="view-competitors.php?sort=zip">ZIP</a></th>
  <th><a href="view-competitors.php?sort=phone">Phone</a></th>
  <th><a href="view-competitors.php?sort=email">Email</a></th>
  <th><a href="view-competitors.php?sort=lvl">Level</a></th>
  <th><a href="view-competitors.php?sort=sex">Sex</a></th>
  <th><a href="view-competitors.php?sort=team_id">Team ID</a></th>
</thead>
';
...
if ($pages > 1) {
  ...
  if ($current_page != 1) {
    echo '<a href="view-competitors?s=' . ($start - $display) . '&p=' . $pages . '&sort=' . $sort . '">Previous</a> ';
  }
  // Make all the numbered pages:
  for ($i = 1; $i <= $pages; $i++) {
    if ($i != $current_page) {
      echo '<a href="view-competitors.php?s=' . (($display * ($i - 1))) . '&p=' . $pages . '&sort=' . $sort . '">' . $i . '</a> ';
    } else {
      echo $i . ' ';
    }
  } // End of FOR loop.
  ...
  if ($current_page != $pages) {
    echo '<a href="view-competitors.php?s=' . ($start + $display) . '&p=' . $pages . '&sort=' . $sort . '">Next</a>';
  }
       ...
       <div class="MenuItemContainer clearfix grpelem temp_no_id" data-orig-id="u2398"><!-- vertical box -->
        ...
        <div class="SubMenu MenuLevel1 clearfix temp_no_id" data-orig-id="u2399"><!-- vertical box -->
         <ul class="SubMenuView clearfix colelem temp_no_id" data-orig-id="u2400"><!-- vertical box -->
          ...
          <li class="MenuItemContainer clearfix colelem temp_no_id" data-orig-id="u14717"><!-- horizontal box --><a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem temp_no_id" href="view-competitors.php" data-orig-id="u14718"><!-- horizontal box --><img class="MenuItemLabel NoWrap grpelem temp_no_id" alt="&nbsp;View Competitors" src="images/blank.gif?crc=4208392903" data-orig-id="u14721"/><!-- state-based BG images --></a></li>
